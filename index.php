...
<head>
    ...
    <style>
      /* إخفاء أيقونات الترتيب أو الأسهم التلقائية التي تظهر في بعض المتصفحات */
select, 
input, 
textarea,
button,
...
/* إزالة الأسهم التي قد تظهر بسبب أيقونات Font Awesome أو Bootstrap */
.fa-sort, 
.fa-caret-down, 
.fa-caret-up {
    display: none !important;
        ...
        .sidebar { background: #faf8f9ff; border-radius: 10px; padding: 15px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }
...
<div class="container-fluid p-0">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <?php echo isset($_SESSION['username']) ? "<li class='nav-item'><a class='nav-link' href='./users_area/profile.php'>My Account</a></li>" : "<li class='nav-item'><a class='nav-link' href='./users_area/user_registration.php'>Register</a></li>"; ?>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-secondary mb-4">
        <ul class="navbar-nav me-auto px-3">
            <li class="nav-item"><a class="nav-link" href="#">Welcome <?php echo isset($_SESSION['username']) ? $_SESSION['username'] : "Guest"; ?></a></li>
            <li class="nav-item"><a class="nav-link" href="<?php echo !isset($_SESSION['username']) ? './users_area/user_login.php' : './users_area/logout.php'; ?>">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-2 " >
                <div class="sidebar ">
                    <div class="sidebar-title text-center"><h6>Brands</h6></div>
                    <ul class="navbar-nav text-center">
                        <?php getbrands(); ?>
                    </ul>
                    <div class="sidebar-title text-center mt-4"><h6>Categories</h6></div>
                    <ul class="navbar-nav text-center">
                        <?php getcategories(); ?>
                    </ul>
                </div>
